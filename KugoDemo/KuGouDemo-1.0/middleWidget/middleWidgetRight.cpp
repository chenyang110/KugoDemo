...
void middleWidgetRight::init()
{
    ...
    m_stackWid->addWidget(m_lrcwid=new LycLabel(false,this));
    ...
    m_web0->m_web->setUrl(QUrl("http://www2.kugou.kugou.com/yueku/v9/html/home.html"));
    //m_web0->m_web->setUrl(QUrl("qrc::/css/QWebViewStyle.html"));
    m_web0->m_web->show();
    m_web1->m_web->load(QUrl("http://www2.kugou.kugou.com/fm2/app/publicV2/html/recommend/index.html"));
    m_web1->m_web->setUrl(QUrl("http://www2.kugou.kugou.com/fm2/app/publicV2/html/recommend/index.html"));
    //m_web1->m_web->setUrl(QUrl("qrc:/css/QWebViewStyle.html"));
    m_web1->m_web->show();

        m_web2->m_web->load(QUrl("http://www2.kugou.kugou.com/yueku/v9/html/default_special.html?ver=8071"));
        m_web2->m_web->setUrl(QUrl("http://www2.kugou.kugou.com/yueku/v9/html/default_special.html?ver=8071"));
        //m_web2->m_web->setUrl(QUrl("qrc:/css/QWebViewStyle.html"));
        m_web2->m_web->show();

        m_web3->m_web->load(QUrl("http://www2.kugou.kugou.com/mv/v9/html/mvradio.html"));
        m_web3->m_web->setUrl(QUrl("http://www2.kugou.kugou.com/mv/v9/html/mvradio.html"));
        //m_web3->m_web->setUrl(QUrl("qrc:/css/QWebViewStyle.html"));
        m_web3->m_web->show();

        m_web4->m_web->load(QUrl("http://fanxing.kugou.com/mini/index.html?ver=8071"));
        m_web4->m_web->setUrl(QUrl("http://fanxing.kugou.com/mini/index.html?ver=8071"));
        //m_web4->m_web->setUrl(QUrl("qrc::/css/QWebViewStyle.html"));
        m_web4->m_web->show();
...
void middleWidgetRight::slot_setSearchStack()//搜索界面
{
        ...
        QString text=ledit->text().simplified();//从开头和结尾删除空格
        if(text.isEmpty())
